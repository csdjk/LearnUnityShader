/*
* @Descripttion: 次表面散射 - 一个pass Forwardbase中计算点光源
* @Author: lichanglong
	...
	SubShader {
		Pass{
			...
			fixed4 frag(v2f i): SV_TARGET{
				...
				// --------------点光源--------------
				// float3 pointLightPos0 = float3(unity_4LightPosX0[0],unity_4LightPosY0[0],unity_4LightPosZ0[0]);
				// float3 pointLightColor0 = unity_LightColor[0].rgb;

				// float3 pointLightDir = normalize(pointLightPos0 - i.worldPos);
